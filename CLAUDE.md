...
## tmux — Enterprise Identity

This repo is **tmux**: a **zepo** (enterprise infrastructure fork) in Steve's Zgent Enterprise.
...
- **Bead prefix:** `tx`
- **Upstream:** `tmux/tmux` (fetch freely, never push enterprise artifacts to it)
- **Origin:** `justSteve/tmux`

### Fork Doctrine

This fork exists because Steve deliberately appropriated the intellectual capital
of `tmux/tmux`. This is offensive, not defensive — Steve chose to stand on these
